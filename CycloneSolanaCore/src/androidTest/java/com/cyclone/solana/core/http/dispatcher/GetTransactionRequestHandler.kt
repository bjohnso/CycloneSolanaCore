...
object GetTransactionRequestHandler: MockRequest {
    ...
    override suspend fun validateRequest(request: HttpRequestData): Boolean {
        ...
        val requestModel = json.decodeFromString(
            RPCRequest.RequestGetTransaction.serializer(),
            requestJson
        )

        return requestModel.id == RPC.RPCMethodIds.GET_TRANSACTION &&
                requestModel.method == RPC.RPCMethods.GET_TRANSACTION &&
